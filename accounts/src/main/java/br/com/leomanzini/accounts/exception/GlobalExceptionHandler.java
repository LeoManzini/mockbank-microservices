...
// @ControllerAdvice is saying to spring that this class is a global handler for exceptions
// that are thrown in the application. It will handle all exceptions that are not handled by any other
@ControllerAdvice
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // @ExceptionHandler is saying to spring that this method will handle the exception that is passed as parameter
